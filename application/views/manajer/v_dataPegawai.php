            ...
            <div class="modal-content">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <<<<<<< HEAD <input type="text" class="form-control" id="namaPegawai" value="" name="namaPegawai" placeholder="Nama Pegawai">
                            <div class="error"></div>
                            =======
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <<<<<<< HEAD <input type="date" class="form-control" id="tglLahir" value="" name="tglLahir" placeholder="">
                            <div class="error"></div>
                            =======
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <<<<<<< HEAD <input type="text" class="form-control" id="alamat" value="" name="alamat" placeholder="Alamat">
                            <div class="error"></div>
                            =======
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <<<<<<< HEAD <input type="text" class="form-control" id="noTelp" name="noTelp" placeholder="Nomor Telepon">
                            <div class="error"></div>
                            =======
...
<<<<<<< HEAD <div class="modal fade" id="modal-info" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
    ...
    <script type="text/javascript">
        ...
        $("#tablePegawai").on('click', '.btn-edit', function() {
            ...
            $('#namaPoto').val(image);
            $('#img').html('<img src=http://localhost/SERASA/assets/images/' + image + ' class="img-circle elevation-2" alt="User Image" width="50">');
            $('#old_image').val(image);
