                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url(); ?>order">Data Pesanan</a></li>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap" id="tblDetailOrder">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="6" align="right"><a href="<?= base_url(); ?>Pemesanan/cetak/<?= $Detail['id_pesanan']; ?>" target="_blank" type="button" class="btn btn-success"><i class="fa fa-print"> Cetak</i></a> </td>
                                        </tr>
                                    </tfoot>
